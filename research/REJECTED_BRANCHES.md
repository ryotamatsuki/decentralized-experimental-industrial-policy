...
- generic learning externality / under-experimentation: `KILL AS MAIN CONTRIBUTION`.
- self-discovery/imitation: `KILL AS MAIN CONTRIBUTION`.
- local-information advantage alone: `KILL AS MAIN CONTRIBUTION`.
- decentralized experimentation alone: `KILL AS MAIN CONTRIBUTION`.
- generic subsidy competition: `KILL`.
- government test bed -> supplier commercialization alone: `KILL`.
...
## Autonomous IO–Industrial Policy Search — 2026-08-29

The following five candidates were tested on the controller branch. These
entries are terminal negative results for this run; they do not reopen any
binding historical kill.

- Cycle 1 — public procurement lotting and complementor entry: **NO-GO at Stage 2**. Procurement bundling, lot division, contract scope, and complementor/PPP design structurally contain the proposed mechanism.
- Cycle 2 — public deployment data access and downstream competition: **NO-GO at Stage 2**. Deployment-generated data, data pooling, learning-by-deploying, capacity, and competition have exact or high-overlap prior art.
- Cycle 3 — public eligibility and vertical organization: **NO-GO at Stage 2**. Entry, subcontracting, vertical boundaries, and procurement governance structurally contain the proposed effect.
- Cycle 4 — public-anchor learning and entry timing: **NO-GO at Stage 4**. The timing effect exists, but setting the learning barrier to zero leaves standard public disclosure plus entry; the welfare sign is not generated by the proposed anchor.
- Cycle 5 — advance public purchase commitment and later re-tender: **NO-GO at Stage 2**. Dynamic procurement, buyer commitment, supplier investment, and later competition already contain the proposed mechanism.
